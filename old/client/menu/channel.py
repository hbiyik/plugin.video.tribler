...
class Channel(object):
    ...
    def discovered(self):
        from client.module.perform_request import request_discovered_channels
    ...
    def recommanded_channels(self):
        limit = 9
        from client.module.perform_request import request_recommanded_channels
    ...
    def subscriptions(self):
        from client.module.perform_request import request_subscribed_channels
    ...
    def subscribe(self, channel_id, name):
        from client.module.perform_request import subscribe_channel
